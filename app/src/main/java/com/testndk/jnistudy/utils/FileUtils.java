...
public class FileUtils {
    ...
    public static String writeContent(byte[] array, boolean needFile) {
        return writeContent(array, needFile, "code.txt");
    }

    public static String writeContent(byte[] array, boolean needFile, String fileName) {
        char[] HEX_CHAR_TABLE = {
