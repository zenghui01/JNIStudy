 ...
 */
package com.testndk.jnistudy.utils.interfaces;
...
public interface IPanelConflictLayout {
     ...
     * Keyboard->Panel
     *
     * @see KPSwitchConflictUtil#showPanel(View)
     */
    void handleShow();
     ...
     * @see KPSwitchPanelLayoutHandler#resetToRecommendPanelHeight(int)
     * @see KeyboardUtil#getValidPanelHeight(Context)
     */
