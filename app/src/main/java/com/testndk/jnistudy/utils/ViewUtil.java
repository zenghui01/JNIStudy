...
//            //fix bug
//            validPanelHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 280, view.getContext().getResources().getDisplayMetrics());
//        }
...
//
//    @TargetApi(Build.VERSION_CODES.KITKAT)
//    public static boolean isTranslucentStatusForKeyboardUtil(final Activity activity) {
//        //noinspection SimplifiableIfStatement
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//            return existFlag(activity.getWindow().getDecorView(), View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);
...
//    }
//
//    static boolean existFlag(View view, int flags) {
//        if (view.getSystemUiVisibility() != 0 && flags == (view.getSystemUiVisibility() & flags)) {
//            return true;
//        }
//        return false;
//    }
