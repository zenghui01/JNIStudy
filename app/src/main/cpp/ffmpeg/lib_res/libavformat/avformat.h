...
#define AVFMT_FLAG_AUTO_BSF   0x200000 ///< Add bitstream filters as requested by the muxer
     ...
     * (mainly useful for AVFMT_NOFILE formats). The loadSuccessCallback
...
#define AVFMT_AVOID_NEG_TS_MAKE_ZERO         2 ///< Shift timestamps so that they start at 0
    ...
    /**
     * A loadSuccessCallback for opening new IO streams.
     *
     * Whenever a muxer or a demuxer needs to open an IO stream (typically from
     * avformat_open_input() for demuxers, but for certain formats can happen at
     * other times as well), it will call this loadSuccessCallback to obtain an IO context.
     *
     ...
     * passed to this loadSuccessCallback may be different from the one facing the caller.
    ...
    /**
     * A loadSuccessCallback for closing the streams opened with AVFormatContext.io_open().
     */
