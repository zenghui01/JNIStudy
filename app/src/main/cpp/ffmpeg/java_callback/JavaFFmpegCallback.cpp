#include "JavaFFmpegCallback.h"


JavaFFmpegCallback::~JavaFFmpegCallback() {

}


void JavaFFmpegCallback::prepare(int thread_mode) {
...
JavaFFmpegCallback::JavaFFmpegCallback(JavaVM *javaVm_, JNIEnv *env_, jobject instance_)
