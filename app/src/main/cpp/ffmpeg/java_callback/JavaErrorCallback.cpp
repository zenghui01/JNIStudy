#include "JavaErrorCallback.h"

void JavaErrorCallback::onError(int method, jint code, const char *str) {
...
JavaErrorCallback::~JavaErrorCallback() {

}

JavaErrorCallback::JavaErrorCallback(JavaVM *javaVM_, JNIEnv *env_, jobject instance_)
